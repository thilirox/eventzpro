<%-- 
    ...
    Created on : Oct 23, 2016, 5:06:00 PM
...
<div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">you have the following service orders!</h2>
                     <hr class="primary">
                     <br/>
       ...
       <table class="table table-bordered">
           ...
           <tr>
             ...
             <td>
                 <a href="updateOrder.jsp?id=<%=cusreq.getString("ReqID") %>" > Confirm </a>
             </td>
