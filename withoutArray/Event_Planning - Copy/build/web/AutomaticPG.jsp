          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h3 class="section-heading">  Enter Your Request </h3>
                      ...
                      <fieldset id="1">
                       <h4>  Hotels </h4> 
                            <div class="checkbox-inline">
                                 <label><input type="checkbox" name="id" value="Hotel"> Five Star</label>
                                  
                            </div>
                          <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="Hotel"> Four Star</label>
                                  
                            </div>
                      <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="Hotel"> Other</label>
                      ...
                      <h4>  Photography </h4>
                           <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="Photography">Premium</label>
                                </div>
                        <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="Photography">Normal</label>
                                </div>
                      </fieldset>
                      <fieldset>
                      <h4> Decorations </h4>
                               <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="decorations">Premium</label>
                                </div>
                       <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="decorations">Normal</label>
                                </div>
                      </fieldset>
                      <fieldset>
                      <h4> Music And Sounds </h4>
                            <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="Music">Classic</label>
                                </div>
                      <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="Music">Calipso</label>
                                </div>
                      <div class="checkbox-inline">
                                 <label><input type="checkbox"  name="id" value="Music">DJ</label>
                                </div>
                      </fieldset>
                      <fieldset>
                      <h4>Other </h4>
