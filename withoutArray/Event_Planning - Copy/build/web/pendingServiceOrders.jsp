<%-- 
    Document   : pendingServiceOrders
    Created on : Jan 8, 2017, 3:00:02 PM
    Author     : user
--%>
                        ...
                        <div class="col-lg-9 main-chart">
                            <div class="row mtbox">
                                ...
                                <table id="Pending" class="table table-bordered">
                                    ...
                                    <%   while (cusreq.next()) {%>
                                    <tr >
                           <td id="reqid"><%=cusreq.getString("ReqID")%></td>
                                        <td><ul>
                                        ...
                                        <td>
                                            <a href="pendingOrderConfirm.jsp?ReqId=<%=cusreq.getString("ReqID")%>" >
                                                Set Confirm </a>                                       
                                        </td>
